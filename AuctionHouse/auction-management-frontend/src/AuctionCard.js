...
const AuctionCard = ({ auction }) => {
  ...
  return (
    <div className="relative w-full h-full p-6 py-2 border-gray-300 shadow-sm group">
      <div className="relative transition-opacity duration-300 border-2 group-hover:opacity-40">
        {/* Image Section */}
        <img
          src={image}
          alt={title}
